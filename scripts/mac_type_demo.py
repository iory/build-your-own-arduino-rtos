...
c = pexpect.spawn("/bin/zsh -f", encoding="utf-8", timeout=None, dimensions=(20, 84),
                  env={"TERM": "xterm-256color", "HOME": "/Users/iory",
                       "PATH": "/Users/iory/.local/bin:/opt/homebrew/bin:/usr/bin:/bin:/usr/sbin"})
...
pump(0.4)
c.send("cd /Users/iory/src/github.com/iory/build-your-own-arduino-rtos/code\n")
pump(0.6)
c.send("clear\n")
pump(1.5)
