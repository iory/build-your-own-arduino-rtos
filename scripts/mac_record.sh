...
tell application "Terminal"
    activate
    do script "exec /Users/iory/.local/bin/uv run --no-project --with pexpect python3 /private/tmp/claude-501/-Users-iory-src-github-com-iory-learning-os-from-arduino/9a60c8b3-7892-4250-b422-eb629e4df97d/scratchpad/mac_type.py"
    delay 0.8
